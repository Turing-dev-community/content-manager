...
| 2025-11-19      | ankita.k@turing.com     | Implement Ratelimit per API                                                                                                                     | Make rate limits configurable per API| [#97](https://github.com/Turing-dev-community/content-manager/issues/97)   |
| 2025-11-19      | ankita.k@turing.com     | Implement Soft delete for blog posts|  soft-delete functionality for blog posts and enhances all GET endpoints to optionally return soft-deleted data.| [#120](https://github.com/Turing-dev-community/content-manager/issues/120) |
