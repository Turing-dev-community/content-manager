...
| 2025-11-19 | riddhi.s@turing.com | User-owned Webhooks | Users can register, list, update and delete their own webhook URLs to receive real-time notifications. Full CRUD via `/api/users/{userId}/webhooks`, strict URL validation, ownership enforced, returns 400 on invalid URL and 404 on missing user/webhook. | [#95](https://github.com/Turing-dev-community/content-manager/issues/95) |
